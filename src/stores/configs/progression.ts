...
export const TECH_TREE: TechDef[] = [
  ...
  { id: 'ai_infrastructure', branch: 'performance', label: 'AI Infrastructure', description: 'High-density GPU pods, rear-door heat exchangers, and direct-to-chip liquid cooling. Unlocks GPU pod deployment and the AI Lab customer segment.', cost: 100000, researchTicks: 120, prereqId: 'gpu_clusters', effect: 'Unlocks GPU pods (64–256 GPU clusters) + liquid cooling' },
...
export const ACHIEVEMENT_CATALOG: AchievementDef[] = [
  ...
  { id: 'first_ticket_closed', label: 'First Responder', description: 'Close your first incident ticket.', icon: '🎫' },
  { id: 'zero_backlog', label: 'Inbox Zero', description: 'Clear your ticket backlog after filing 10+ tickets.', icon: '📭' },
  { id: 'fast_mttr', label: 'Rapid Response', description: 'Reach an average MTTR under 10 ticks (5+ tickets resolved).', icon: '⚡' },
  { id: 'sla_clean_sheet', label: 'Clean Sheet', description: 'Resolve 15 tickets without a single SLA breach.', icon: '🧼' },
...
export const TUTORIAL_TIPS: TutorialTip[] = [
  ...
  { id: 'first_ticket', title: 'Ticket Filed', message: 'That incident auto-filed a ticket in the Tickets panel. Work the board — P1s have the tightest SLA. Keep MTTR low and breaches at zero.', category: 'incidents' },
